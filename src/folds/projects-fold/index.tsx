                ...
                <div className="flex flex-col gap-[1rem]">
                  ...
                  <div className="flex justify-start items-start">
                    <h6 className="font-light">
                      ...
                      the React framework and web3 technologies, we built a
                      secure application for automating healthcare. It showcases
                      our ability to create user-friendly and tamper-proof
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                <div className="flex flex-col gap-[1rem]">
                  ...
                  <div className="flex justify-start items-start">
                    <h6 className="font-light">
                      GDSC Landing Page is a website that showcases the
                      different projects and events of GDSC Mapúa MCM. Reaching
                      out to students and developers, it serves as a hub for
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent>
                <div className="flex flex-col gap-[1rem]">
                  ...
                  <div className="flex justify-start items-start">
                    <h6 className="font-light">
                      A JavaScript library that helps developers to animate
                      their websites, this includes a website demo to showcase
                      those animations.
                    </h6>
                  </div>
                  <div className="flex flex-wrap gap-[1rem] justify-start items-center">
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent>
                <div className="flex flex-col gap-[1rem]">
                  ...
                  <div className="flex justify-start items-start">
                    <h6 className="font-light">
                      TicketLy is a Discord bot that helps server owners to
                      manage their server by creating tickets for their members,
                      this promotes a more organized and efficient way of
